...
namespace GameDevGame2
{
	...
	public class Cube
	{
		...
		public void InitializeVertices()
		{
			...
			new VertexPositionColor() { Position = new Vector3(-0.25f,  0.25f, -0.25f), Color = Color.Blue },
			new VertexPositionColor() { Position = new Vector3( 0.25f,  0.25f, -0.25f), Color = Color.Green },
			new VertexPositionColor() { Position = new Vector3(-0.25f, -0.25f, -0.25f), Color = Color.Red },
			new VertexPositionColor() { Position = new Vector3( 0.25f, -0.25f, -0.25f), Color = Color.Cyan },
			new VertexPositionColor() { Position = new Vector3(-0.25f,  0.25f,  0.25f), Color = Color.Blue },
			new VertexPositionColor() { Position = new Vector3( 0.25f,  0.25f,  0.25f), Color = Color.Red },
			new VertexPositionColor() { Position = new Vector3(-0.25f, -0.25f,  0.25f), Color = Color.Green },
			new VertexPositionColor() { Position = new Vector3( 0.25f, -0.25f,  0.25f), Color = Color.Cyan }
		...
		public Cube(Game game)
		{
			...
			InitializeIndices();
			InitializeEffect();
			this.bounds = new BoundingRectangle(position.X-25, position.Y-25, 50, 50);
		}
	}
}
